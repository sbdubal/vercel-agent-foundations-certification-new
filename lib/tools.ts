...
import { tool } from "ai";
import { z } from "zod";
// import { ApiRequestError, getProducts, getCategories } from "@/lib/api";
...
export const getProductDetails = tool({
  description: `Get detailed information about a specific product in the Vercel swag store by its ID or slug.`,
  inputSchema: z.object({
    idOrSlug: z.string().describe("The ID or slug of the product to retrieve."),
  }),
